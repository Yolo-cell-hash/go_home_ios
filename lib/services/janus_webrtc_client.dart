// services/janus_webrtc_client.dart
// Janus WebRTC client for VDB video streaming - cloned from vdp-sdk-aws-migration
...
/// Janus WebRTC client for connecting to Janus gateway and streaming video
class JanusWebRTCClient {
  ...
  Future<void> _createPeerConnection() async {
    // ICE configuration for low latency
    final configuration = {
      'iceServers': [
        {'urls': 'stun:13.203.89.154:3478'},
        {
          'urls': 'turns:vdb-poc.duckdns.org:5349',
          'username': 'vdb-poc',
          'credential': 'vdb-poc',
        },
        {
          'urls': 'turn:vdb-poc.duckdns.org:3478?transport=tcp',
          'username': 'vdb-poc',
          'credential': 'vdb-poc',
        },
